...
#+begin_src emacs-lisp
  ...
  ;;  '(lsp-volar :type git :host github :repo "sellout/emacs-color-theme-solarized"))
...
#+begin_src emacs-lisp
  ...
  (defun setup-company-backends ()
    (setq company-backends
          '(company-files
            (company-tide :with company-dabbrev-code :with company-yasnippet :separate)
  ...
  (use-package company
    ...
    :bind (:map company-active-map
                ...
                ("C-n" . company-select-next)
                ("C-p" . company-select-previous))
    :hook ((emacs-lisp-mode . setup-company-backends))
    :config
...
#+begin_src emacs-lisp
  (use-package lsp-mode
    ...
    (setq lsp-typescript-format-insert-space-after-opening-and-before-closing-nonempty-parenthesis nil)
