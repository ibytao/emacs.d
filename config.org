   ...
   #+begin_src emacs-lisp
     ...
     (add-hook 'js2-mode-hook
               (lambda ()
                 ...
                 (define-key js2-mode-map (kbd "TAB") 'hs-toggle-hiding)))

     (add-hook 'go-mode-hook
               (lambda ()
                 (global-unset-key (kbd "TAB"))
                 (define-key go-mode-map (kbd "TAB") 'hs-toggle-hiding)))

     (add-hook 'java-mode-hook
               (lambda ()
                 (global-unset-key (kbd "TAB"))
                 (define-key java-mode-map (kbd "TAB") 'hs-toggle-hiding)))
   #+end_src
** Theme
   #+begin_src emacs-lisp
     ;; -------------------------------------------------------------------------------------------------------
...
** font
   #+begin_src emacs-lisp
     ...
     ;; (set-face-attribute 'default nil :font "-apple-Menlo-normal-normal-normal-*-16-*-*-*-m-0-iso10646-1")
