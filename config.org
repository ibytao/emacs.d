...
#+begin_src emacs-lisp
  (use-package lsp-dart
  	:ensure t
  	:defer t
  	:hook ((dart-mode . lsp-bridge-mode)
  ...
  (use-package lsp-tailwindcss
    ...
    (lsp-register-client
     (make-lsp-client
      ...
      :activation-fn (lambda (filename mode) ;; 文件激活条件
                       (member mode '(html-mode css-mode web-mode
  																							typescript-mode typescriptreact-mode
  																							javascript-mode javascriptreact-mode)))
